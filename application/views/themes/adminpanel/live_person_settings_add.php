...
<div class="col-md-12" >
  <div class="panel panel-default">
      <div class="panel-heading">
          <h4><?php print $this->lang->line('add_live_person'); ?></h4>
      </div>
      <div class="panel-body">
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="consumer_key" name="consumer_key" data-parsley-trigger="focusout" data-parsley-errors-messages-disabled>
          </div>
          <div class="form-group col-md-6">
            <label for="Access Token"><?php print $this->lang->line('access_token'); ?></label>
            <input type="text" class="form-control" id="access_token" name="access_token" data-parsley-trigger="focusout" data-parsley-errors-messages-disabled>
          </div>
        </div>
        ...
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="consumer_secret" name="consumer_secret" data-parsley-trigger="focusout" data-parsley-errors-messages-disabled>
          </div>
          <div class="form-group col-md-6">
            <label for="Access Token Secret"><?php print $this->lang->line('access_token_secret'); ?></label>
            <input type="text" class="form-control" id="access_token_secret" name="access_token_secret" data-parsley-trigger="focusout" data-parsley-errors-messages-disabled>
          </div>
        </div>
