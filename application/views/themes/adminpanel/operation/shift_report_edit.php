...
<?php print form_open('adminpanel/operation/shift_report_edit/' . $report->shift_reports_id, 'class="form-confirm"') . "\r\n"; ?>
<div class="col-md-12">
    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="player_name" name="player_name" value="<?php print $report->player_name?>">
                </div>
                <div class="form-group">
                    <label for="status"><?php print $this->lang->line('status'); ?></label>
                    <select class="form-control" id="status" name="status">
                        <option value="active" <?php print ($report->status == 'active') ? "selected" : ""; ?>><?php print $this->lang->line('active');?></option>
                        <option value="inactive" <?php print ($report->status == 'inactive') ? "selected" : ""; ?>><?php print $this->lang->line('inactive');?></option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="follow_up" name="follow_up" value="<?php print $report->follow_up?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control datetimepicker" id="finish" name="finish" value="<?php print $report->finish?>">
                </div>
                <div class="form-group">
                    <label for="remarks"><?php print $this->lang->line('remarks'); ?></label>
                    <textarea class="form-control" id="remarks" name="remarks" rows="4" style="resize: vertical;"><?php print $report->remarks?></textarea>
                </div>
            </div>
        </div>
    </div>
