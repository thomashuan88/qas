...
<?php print form_open('adminpanel/operation/shift_report_edit/' . $report->shift_reports_id, 'id="shift_report_edit_form"') . "\r\n"; ?>
<div class="col-md-12">
    <div class="col-md-6">
    ...
    <div>
        <button type="submit" id="shift_report_edit_submit" name="shift_report_edit_submit" class="btn btn-success"><i class="fa fa-floppy-o pd-r-5"></i>&nbsp;<?php print $this->lang->line('save'); ?></button>
        <a href="<?php print base_url() . "adminpanel/operation/shift_report?type=session"; ?>"><button type="button" class="btn btn-danger"><i class="fa fa-reply pd-r-5"></i>&nbsp;<?php print $this->lang->line('cancel'); ?></button></a>
    </div>
</div>
