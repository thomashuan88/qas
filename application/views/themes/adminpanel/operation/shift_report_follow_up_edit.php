...
<?php print form_open('adminpanel/operation/shift_report_follow_up_edit/' . $key . '/' . $follow_up->follow_up_id, 'id="shift_report_follow_up_edit_form"') . "\r\n"; ?>
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div>
                <button type="submit" id="shift_report_follow_up_edit_submit" name="shift_report_follow_up_edit_submit" class="btn btn-success"><i class="fa fa-floppy-o pd-r-5"></i>&nbsp;<?php print $this->lang->line('save'); ?></button>
                <a href="<?php print base_url('adminpanel/operation/shift_report_follow_up') . "/" . $key . '?type=session'; ?>"><button type="button" class="btn btn-danger"><i class="fa fa-reply pd-r-5"></i>&nbsp;<?php print $this->lang->line('cancel'); ?></button></a>
            </div>
        </div>
    </div>
</div>
