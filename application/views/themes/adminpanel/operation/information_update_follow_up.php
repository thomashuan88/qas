...
<?php if ($add) { ?>
    <div class="col-xs-12" style="text-align: right; margin-bottom: 20px;">
        <a href="<?php print base_url() . "adminpanel/operation/information_update_follow_up_insert/" . $report->shift_reports_id; ?>">
...
<div class="row margin-top-30">
    <div class="col-xs-12">
        ...
        <div class="table-responsive" id="information_update_follow_up_table">
...
<script type="text/javascript">
    ...
    var paging = {
        ...
        search_data: {},
        permission: {},
        ajaxUrl: "<?php print base_url('adminpanel/operation/get_information_update_follow_up') . '/' . $report->shift_reports_id; ?>"
    };
    ...
    var drawTable = function (data) {
        ...
        if (data.length != 0) {
            $('#information_update_follow_up_table').css('display', 'block');
            $('#no_result').css('display', 'none');
        } else {
            $('#information_update_follow_up_table').css('display', 'none');
        ...
        $.each(data, function (key, value) {
            ...
            if (paging.permission['edit']) {
                html += '<a href="<?php print base_url('adminpanel/operation/information_update_follow_up_edit') . '/' . $report->shift_reports_id . '/';?>' + value['follow_up_id'] + '" class="btn btn-primary btn-circle edit" title="<?php print $this->lang->line('edit')?>" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="fa fa-pencil-square"></i></a>';
            }
