...
<?php print form_open('adminpanel/operation/information_update_details_insert/' . $key, 'id="information_update_details_insert_form"') . "\r\n"; ?>
<div class="col-md-12">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <select name="status" id="status" class="form-control" data-parsley-trigger="change focusout" data-parsley-errors-messages-disabled required>
                    <option value="inform" <?php print ($this->session->flashdata('status') == 'inform') ? "selected" : ""; ?>><?php print $this->lang->line('update'); ?></option>
                    <option value="informed" <?php print ($this->session->flashdata('status') == 'informed') ? "selected" : ""; ?>><?php print $this->lang->line('done'); ?></option>
                </select>
            </div>
            <div class="form-group">
            ...
            <div>
                ...
                <a href="<?php print base_url() . "adminpanel/operation/information_update_details/" . $key; ?>"><button type="button" class="btn btn-danger"><i class="fa fa-reply pd-r-5"></i>&nbsp;<?php print $this->lang->line('cancel'); ?></button></a>
            </div>
        </div>
    </div>
</div>
