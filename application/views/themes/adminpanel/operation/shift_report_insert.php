...
<?php print form_open('adminpanel/operation/shift_report_insert', 'id="shift_report_insert_form"') . "\r\n"; ?>
<div class="col-md-12">
    <div class="col-md-6">
    ...
    <div>
        <button type="submit" id="shift_report_insert_submit" name="shift_report_insert_submit" class="btn btn-success"><i class="fa fa-floppy-o pd-r-5"></i>&nbsp;<?php print $this->lang->line('save'); ?></button>
