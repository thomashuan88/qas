...
<?php print form_open('adminpanel/operation/question_type_edit/' . $type->category_group_id, 'id="question_type_edit_form"') . "\r\n"; ?>
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="content" name="content" value="<?php print $type->content;?>" data-parsley-trigger="change keyup focusout" data-parsley-errors-messages-disabled required autocomplete="off"/>
            </div>
            <div class="form-group">
            ...
            <div>
                <button type="submit" id="question_type_edit_submit" name="question_type_edit_submit" class="btn btn-success"><i class="fa fa-floppy-o pd-r-5"></i>&nbsp;<?php print $this->lang->line('save'); ?></button>
