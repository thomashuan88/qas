...
<form name="shift_report_form" id="shift_report_form" onsubmit="return searchData();">
    ...
    <div class="col-xs-12">
        <div class="mg-b-10">
            <h4 class="text-uppercase f900">
                <?php print  $this->lang->line('total_shift_reports') . "&nbsp;:&nbsp;"; ?><span id="total-rows"></span>
            </h4>
        </div>
        <div class="table-responsive" id="shift_report_table">
...
<script type="text/javascript">
    ...
    var paging = {
        ...
        search_data: {},
        permission: {},
        ajaxUrl: "<?php print base_url('adminpanel/operation/get_shift_report') . (!empty($_GET['type']) ? '/' . $_GET['type'] : ''); ?>"
    };
    ...
    var drawTable = function (data) {
        ...
        if (data.length != 0) {
            $('#shift_report_table').css('display', 'block');
        ...
        $.each(data, function (key, value) {
            ...
            if (paging.permission['edit']) {
                html += '<a href="<?php print base_url('adminpanel/operation/shift_report_edit')?>/' + value['shift_reports_id'] + '" class="btn btn-primary btn-circle edit" title="<?php print $this->lang->line('edit')?>" data-toggle="tooltip" data-placement="top" data-original-title="Edit"><i class="fa fa-pencil-square"></i></a>';
            }
