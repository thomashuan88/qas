...
<?php print form_open('adminpanel/operation/question_content_edit/' . $list->category_list_id, 'class="form-confirm"') . "\r\n"; ?>
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="content" name="content" value="<?php print $list->content;?>"/>
                </div>
                <div class="form-group">
