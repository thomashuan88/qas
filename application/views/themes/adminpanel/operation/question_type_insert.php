...
<?php print form_open('adminpanel/operation/question_type_insert/', 'id="question_type_insert_form"') . "\r\n"; ?>
<div class="col-md-12">
    <div class="panel panel-default">
        <div class="panel-body">
            ...
            <div>
                <button type="submit" id="question_type_insert_submit" name="question_type_insert_submit" class="btn btn-success"><i class="fa fa-floppy-o pd-r-5"></i>&nbsp;<?php print $this->lang->line('save'); ?></button>
