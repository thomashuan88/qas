            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="form-control" data-parsley-trigger="change focusout" data-parsley-errors-messages-disabled required>
                        <option value="update" <?php print ($this->session->flashdata('status') == 'update') ? "selected" : ""; ?>><?php print $this->lang->line('update'); ?></option>
                        <option value="updated" <?php print ($this->session->flashdata('status') == 'updated') ? "selected" : ""; ?>><?php print $this->lang->line('done'); ?></option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="panel panel-default">
            <div class="panel-body" style="padding-bottom: 15px;">
                ...
                <div class="form-group">
                    ...
                    <label style="color:red; font-size:14px;">*</label>
                    <textarea class="form-control" id="remarks" name="remarks" rows="3" style="resize: vertical;" data-parsley-trigger="change keyup focusout" data-parsley-errors-messages-disabled required><?php print $this->session->flashdata('remarks');?></textarea>
                </div>
            </div>
        </div>
    </div>
