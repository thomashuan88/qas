...
$("#pending").click(function() {
    ...
    paging = {
        ...
        order_by : 'import_date',
        sort_order : 'desc',
        ajaxUrl: '<?php print base_url('adminpanel/monthly_qa/get_pending'); ?>',
        search_data : {
            status: 0,
...
var confirmImport = function () {
    ...
    $.ajax({
        url: '<?php print base_url('adminpanel/monthly_qa/confirm_pending'); ?>',
        data: requestData,
        type: 'post',
        dataType: 'json',
...
$('#delete_import').click(function() {
    bootbox.confirm('<?php print $this->lang->line('msg_delete_import'); ?>', function(confirmed){
        if (confirmed) {
            ...
            $.ajax({
                url: '<?php print base_url('adminpanel/monthly_qa/delete_pending'); ?>',
                data: requestData,
                type: 'post',
                dataType: 'json',
                success: function(data) {
...
var drawTable = function (data) {
    ...
    if ( paging.ajaxUrl == '<?php print base_url('adminpanel/monthly_qa/get_report'); ?>' ) {
    ...
    $.each( data, function( key, value ) {
        ...
        <?php if( isset( $permission['delete'] ) ): ?>
        html +='<td style="white-space: nowrap;"><a href="#" onclick="deleteData(' + value['monthly_qa_id'] + ')" class="btn btn-danger btn-circle" title="<?php print $this->lang->line('delete')?>" data-toggle="tooltip" data-placement="top" data-original-title="" data-method="DELETE"><i class="fa fa-trash"></i></a></td>';
        <?php endif; ?>
