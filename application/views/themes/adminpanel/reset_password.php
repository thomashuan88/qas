...
<div class="row">
    <div class="col-sm-6 col-sm-offset-3 col-md-4 col-md-offset-4">
       	<?php print form_open('adminpanel/reset_password/send_password', array('id' => 'forgot_password_form')) ."\r\n"; ?>
        ...
        <div class="form-group">
            <button type="submit" class="check_email_empty btn btn-primary btn-lg js-btn-loading" data-loading-text="Checking...">
