...
<?php print form_open('adminpanel/settings/edit_live_person/'.$live_person->sid, 'class="form-confirm"') . "\r\n"; ?>
<div class="col-md-12" >
      ...
      <div class="panel-body">
        <div class="row">
          <div class="form-group col-md-6">
            ...
            <input type="text" class="form-control" id="product" name="product"  value="<?php print $shift->key?>">
          </div>
          <div class="form-group col-md-6">
