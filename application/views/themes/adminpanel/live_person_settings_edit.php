...
<?php print form_open('adminpanel/settings/edit_live_person/'.$product, array('id' => 'live_person_setting_edit_form')) . "\r\n"; ?>
<div class="col-md-12" >
  <div class="panel panel-default">
      ...
      <div class="panel-body">
        ...
        <div class="form-group">
          <button type="submit" id="live_person_setting_edit_submit" class="btn btn-success js-btn-loading" data-loading-text="<?php print $this->lang->line('saving'); ?>"><i class="fa fa-floppy-o pd-r-5"></i> <?php print $this->lang->line('save'); ?></button>
