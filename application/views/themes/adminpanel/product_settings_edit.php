...
<?php print form_open('adminpanel/settings/edit_product/'.$product->sid, 'class="form-confirm"') . "\r\n"; ?>
<div class="col-md-6" >
  <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="product" name="product" value="<?php print $product->value?>">
        </div><br>
        <div class="form-group">
