...
class Performance_log_in_out_model extends CI_Model {

    private $table = 'log_time';
    private $fields;
    ...
    public function get_records( $limit = 0, $offset = 0, $order_by = "import_date", $sort_order = "desc", $search_data = array() , $status = 1, $users = array() ) {
        ...
        $this->db->select( array( 'log_time_id',  'username', 'date', 'login_time', 'chat_time', 'time_online', 'time_online_no_chat', 'time_not_available', 'time_not_available_chat','month', 'leader', 'import_by', 'import_date' ) );
